package hh.learnj.designpattern.nullobject.step4;

import hh.learnj.designpattern.nullobject.step1.AbstractCustomer;
import hh.learnj.designpattern.nullobject.step3.CustomerFactory;
 ...
 * 
 * Implementation We are going to create a AbstractCustomer abstract class
 * defining opearations. Here the name of the customer and concrete classes
 * extending the AbstractCustomer class. A factory class CustomerFactory is
 * created to return either RealCustomer or NullCustomer objects based on the
 * name of customer passed to it.
 * 
