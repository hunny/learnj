package hh.learnj.designpattern.servicelocator.step6;

import hh.learnj.designpattern.servicelocator.step1.Service;
import hh.learnj.designpattern.servicelocator.step5.ServiceLocator;
 ...
 * 
 * Implementation We are going to create a ServiceLocator,InitialContext, Cache,
 * Service as various objects representing our entities.Service1 and Service2
 * represent concrete services.
 * 
 * ServiceLocatorPatternDemo, our demo class, is acting as a client here and
 * will use ServiceLocator to demonstrate Service Locator Design Pattern.
 * 
