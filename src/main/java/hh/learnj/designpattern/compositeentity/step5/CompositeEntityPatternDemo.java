package hh.learnj.designpattern.compositeentity.step5;

import hh.learnj.designpattern.compositeentity.step4.Client;
 ...
 * 
 * Implementation We are going to create CompositeEntity object acting as
 * CompositeEntity. CoarseGrainedObject will be a class which contains dependent
 * objects. CompositeEntityPatternDemo, our demo class will use Client class to
 * demonstrate use of Composite Entity pattern.
 * 
