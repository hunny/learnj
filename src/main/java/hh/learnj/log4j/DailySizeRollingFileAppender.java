...
/**
 * 合并log4j的DailyRollingFileAppender和RollingFileAppender的日志生成功能
 * 
 * <h2>实现说明</h2>
 * <p>
 * 扩展类org.apache.log4j.DailyRollingFileAppender并参照类org.apache.log4j.rolling.RollingFileAppender，
 * 修改了RollingFileAppender中的rollOver方法名称为sizeRollOver并修改了文件名称的生成算法，具体参见{@link #sizeRollOver()}方法
 * <br>
 * 
 * <h2>用法说明</h2>
 * <p>
 * 用法是DailyRollingFileAppender与RollingFileAppender的结合
 * <br>
 * <h2>参考资料</h2>
 * {@link http://logging.apache.org/log4j/1.2/apidocs/org/apache/log4j/DailyRollingFileAppender.html}
 * {@link http://logging.apache.org/log4j/1.2/apidocs/org/apache/log4j/RollingFileAppender.html}
 * 
 * @author huzexiong
 * @since 0.3
 */
public class DailySizeRollingFileAppender extends DailyRollingFileAppender {
   ...
   * before being opened.
   */
  public DailySizeRollingFileAppender(Layout layout, String filename, String datePattern,
   ...
   * to {<code>File.2</code>, ..., <code>File.MaxBackupIndex</code>}. Moreover,
   ...
   * 与<code>RollingFileAppender</code>不同的是，修改了文件的命名方式。 <br>
   * <code>fileName + new SimpleDateFormat(getDatePattern()).format(new Date())</code>
   */
  ...
  void sizeRollOver() {
    ...
    if (maxBackupIndex > 0) {
      ...
      String datedFileName = fileName + new SimpleDateFormat(getDatePattern()).format(new Date());
