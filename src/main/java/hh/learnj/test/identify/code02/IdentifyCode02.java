package hh.learnj.test.identify.code02;
 ...
 * 1. 图像预处理 这验证码还是很厚道的，都没有任何干扰。不用处理
 * 2. 分割 先纵向扫描，很容易分成四部分
 * 再对每一部分横向扫描
 * 3. 训练就容易了 把分割的结果对应存成5.jpg，9.jpg，3.jpg，a.jpg 就可以了
 * 4. 识别 因为固定大小，识别跟 验证码识别--1 里面一样，像素比较就可以了。
 * @author Hunny.Hu
 */
public class IdentifyCode02 {
